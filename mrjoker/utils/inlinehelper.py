...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            description="𝘈𝘯𝘨𝘦𝘭 𝙃𝙚𝙡𝙥 𝙍𝙚𝙡𝙖𝙩𝙚𝙙 𝙏𝙤 𝙄𝙣𝙡𝙞𝙣𝙚 𝙐𝙨𝙖𝙜𝙚",
            input_message_content=InputTextMessageContent(__HELP__),
            thumb_url="https://telegra.ph/file/53093f5a638a1d249f48f.png",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("🥂 𝐌𝐚𝐢𝐧 𝐁𝐨𝐭 🥂", url="https://t.me/AngelxRobot"),
        InlineKeyboardButton("🚀 𝗚𝗼 𝗜𝗻𝗹𝗶𝗻𝗲! 🚀", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[ᴀɴɢᴇʟ](https://t.me/angelsupports):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
...
"""
    answers.append(
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/1d58890894b494a8b8b48.png",
